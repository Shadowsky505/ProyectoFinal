...
@section('content')
    ...
    <section class="mt-10">
        <div class="col text-right">
            <a href="{{ route('reservas.view') }}" class="boton-amarillo">Regresar </a>
        ...
        <div class="mt-10">
            <div
                ...
                <form action="{{ route('reserva.update', $reserva->_id) }}" method="POST">
                    ...
                    <div class="form-group">
                        <label for="cantidad" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Cantidad
                            de
                            personas</label>
                    ...
                    <button type="submit" class="boton-verde mt-4">Guardar cambios</button>
                </form>
            </div>
